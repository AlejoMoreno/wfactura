  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~folder-folder-module~splash-splash-module"], {
    ...
    function srcAppFolderFolderPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var FolderPage = /*#__PURE__*/function () {
        function FolderPage(activatedRoute, router, userService, modalController) {
        ...
        _createClass(FolderPage, [{
          ...
          key: "onchangeCantidad",
          value: function onchangeCantidad() {
            this.TotalProducto();
          }
        }, {
          key: "onchangePrecio",
          value: function onchangePrecio() {
            this.TotalProducto();
          }
        }, {
          key: "onchangeImpuesto",
          value: function onchangeImpuesto() {
          ...
          value: function GuardarFactura() {
            ...
            this.getusuarios();
            this.userService.setFactura(this.email, this.order_total_after_tax, this.order_total_tax, this.order_tax_per, this.order_total_before_tax, this.notas, this.tipo, this.currency, this.direccion, this.nombre).subscribe(function (data) {
              var resultado = data;
              ...
              if (resultado['resultado'] == "error") {
                ...
                _this.ventas = resultado['body'];
                _this.resultadodata = resultado['body']['msm'];

                _this.productos.forEach(function (item) {
                  _this.userService.setProductos(resultado['body']['id'], item.order_item_final_amount, item.order_item_price, item.order_item_quantity, item.item_name, item.item_code).subscribe(function (data) {
                    var resultado = data;
                    console.log(resultado);

                    if (resultado['resultado'] == "error") {//alert(resultado['body']['msm']);
                    } else {
                      _this.resultadodata = _this.resultadodata + resultado['body']['msm'];
                      _this.ventas = resultado['body'];
                    }
                  }, function (error) {
                    console.error(error);
          ...
          value: function GetHistorial() {
            ...
            this.getusuarios();
            this.userService.getHistorial(this.email).subscribe(function (data) {
              var resultado = data;
              console.log(resultado);
          ...
          value: function Login() {
            ...
            this.userService.getUsers(this.email, this.password).subscribe(function (data) {
              var resultado = data;
              console.log(resultado);
          ...
          value: function Setuser() {
            ...
            this.getusuarios();
            this.userService.setUser(this.email, this.password, this.first_name, this.last_name, this.mobile, this.address).subscribe(function (data) {
              var resultado = data;
              console.log(resultado);
...
//# sourceMappingURL=default~folder-folder-module~splash-splash-module-es5.js.map